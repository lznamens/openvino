...
#define CASE_GEMM_ELTWISE_2IN_FP16_1 {{1, 2, 64, 64}, {1, 2, 64, 64}}, {1, 2, 64, 64}, tensor{1}, tensor{0}, data_types::f16, data_types::f16, data_types::f16, format::bfyx, data_types::f16, format::bfyx
...
#define CASE_GEMM_ELTWISE_2IN_S8U8_1 {{1, 2, 64, 64}, {1, 2, 64, 64}}, {1, 2, 64, 64}, tensor{1}, tensor{0}, data_types::i8, data_types::u8, data_types::u8, format::bfyx, data_types::f32, format::bfyx
...
TEST_P(gemm_2in_act_scale_eltwise, basic) {
    // cldnn::engine_configuration conf;
    // conf.sources_dumps_dir = "E:/znamenskiy/test_dumps/";
    // cldnn::engine test_engine(engine_types::ocl, device::create_default(), conf);
